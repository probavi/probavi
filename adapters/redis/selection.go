...
//
// redis_rdb_dir restored the newest member, and nothing else was on offer. A
...
func backupSelection(kind string, params map[string]string) (selectPolicy, *protoError) {
	...
	if !selectsAMember(kind) {
		return "", protoErr("invalid_request", false,
			"source.params.%s applies only to redis_rdb_dir, which chooses a backup for the drill: "+
