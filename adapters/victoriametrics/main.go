// Command probavi-adapter-victoriametrics is the VictoriaMetrics engine adapter for Probavi,
// implementing probavi-adapter/0 (docs/adapter-protocol.md).
//
// Like the sibling adapters it is deliberately self-contained: standard
