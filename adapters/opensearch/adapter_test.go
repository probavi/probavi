...
// returns before the shards' started events land — and a wait that
// expires is judged by the body it carries, which is why that curl runs
// without -f (the expiry answers 408, measured).
