...
// more here than for a single-file artifact: a dump is a tree of avro
// files written one table at a time, so a directory read mid-write holds
// a schema whose data has not arrived yet.
...
//
// A TDengine backup is a dump directory, and a directory's own size and mtime say
